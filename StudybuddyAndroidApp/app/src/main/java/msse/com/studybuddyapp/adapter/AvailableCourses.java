...
public class AvailableCourses extends RecyclerView.Adapter<AvailableCourses.MyViewHolder> {

private Context mContext;
private List<Course> courseList;

public AvailableCourses(Context mContext, List<Course> courseList) {
...
public class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public MyViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_grid_in_demand, parent, false);
